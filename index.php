<?php
include 'koneksi.php'; // Pastikan file ini berisi koneksi ke database MySQL
?>
...
<body>
  ...
  <nav class="navbar navbar-expand-lg">
    <a class="navbar-brand fw-bold text-white" href="#">Kantin<span class="text-danger">Reborn</span></a>
